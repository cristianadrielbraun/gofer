...
- Calendar: `/calendar*` and `/api/accounts/*/calendar/discover` are rendered
  from or mutate the authenticated user's calendar sources; event/source
  lookups must remain user-scoped.
