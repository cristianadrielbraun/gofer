...
const (
	...
	EventScheduledSyncStarted  EventType = "scheduled-sync-started"
	EventScheduledSyncProgress EventType = "scheduled-sync-progress"
	EventScheduledSyncComplete EventType = "scheduled-sync-complete"
